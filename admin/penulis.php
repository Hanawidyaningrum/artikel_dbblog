...
<head>
    ...
    <style>
        ...
        #tabelPenulis_wrapper .dataTables_filter input {
...
<body>
    ...
    <div class="main-content">
        <h2>Penulis</h2>
        <p>Silakan kelola data penulis.</p>

        <a href="tambah_penulis.php" class="btn btn-penulis-baru">
            <i class="fas fa-user-plus"></i> Penulis Baru
        </a>

        <table id="tabelPenulis" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    <a href="edit_penulis.php?id=<?= $author['id']; ?>" class="btn btn-warning btn-sm" title="Ubah">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <a href="hapus_penulis.php?id=<?= $author['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus penulis ini?')" title="Hapus">
